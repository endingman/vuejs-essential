  ...
  <div class="row">
    <div class="col-md-4 col-md-offset-4 floating-box">
      <div class="panel panel-default">
        ...
        <!-- 添加 data-validator-form 属性，使其成为所有验证项的父级： -->
...
export default {
  ...
  created() {
    // 生命周期钩子 created 在实例创建完成后被立即调用，此时我们已经能访问实例的数据对象和方法了。为了在页面加载时就显示一个验证码，我们在 created 钩子里调用了 getCaptcha 方法，用来将返回的验证码模板添加到实例的 captchaTpl，并将验证码添加到实例的 localCaptcha
    this.getCaptcha()
  },
  methods: {
    getCaptcha() {
